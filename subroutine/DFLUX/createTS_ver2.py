def CTS( Modelname, Partname, Acoordinates, Bcoordinates, Ccoordinates, Dcoordinates, m, n, Orientation):
...
def CTSH( Modelname, Partname, Acoordinates, Bcoordinates, Ccoordinates,Dcoordinates, m, n, dx, dy, Nmax, Orientation ):
	...
	t = MyPart.MakeSketchTransform(sketchPlane=MyFace,sketchUpEdge=MyEdge)
...
if __name__ == '__main__':
	CTS(Modelname="Model-1",Partname="Part-1",Acoordinates=(-60,17.5),Bcoordinates=(60,12.5),Ccoordinates=(52.5,3.5,60.),
		Dcoordinates=(52.5,3.5,0.),m=60,n=3,Orientation="HU")
	CTS(Modelname="Model-1", Partname="Part-1", Acoordinates=(-60, 17.5), Bcoordinates=(60, 12.5), Ccoordinates=(17.5,3.5,60.),
		Dcoordinates=(17.5,3.5,120.), m=60, n=3, Orientation="HU")
